            ...
            <div className="tiles-item reveal-from-bottom" data-reveal-delay="400">
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  ...
                  <p className="m-0 text-sm">
                  We understand the IT challenges facing retailers today and how critical it is to keep revenue-driving systems running 24/7, which is why we provide support for POS, e-commerce, order management, and CRM systems, to name a few.
                    </p>
                </div>
              </div>
            </div>
